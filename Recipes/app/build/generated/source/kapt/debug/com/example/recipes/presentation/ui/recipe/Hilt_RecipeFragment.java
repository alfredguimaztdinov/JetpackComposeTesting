...
public abstract class Hilt_RecipeFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_RecipeFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((RecipeFragment_GeneratedInjector) generatedComponent()).injectRecipeFragment(UnsafeCasts.<RecipeFragment>unsafeCast(this));
  }
