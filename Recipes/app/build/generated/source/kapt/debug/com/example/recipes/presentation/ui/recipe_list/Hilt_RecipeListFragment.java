...
public abstract class Hilt_RecipeListFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_RecipeListFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((RecipeListFragment_GeneratedInjector) generatedComponent()).injectRecipeListFragment(UnsafeCasts.<RecipeListFragment>unsafeCast(this));
  }
